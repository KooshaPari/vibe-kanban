...
fn generate_types_content() -> String {
    ...
    let decls = [
        ...
        vibe_kanban::models::project_manager_session::ProjectManagerSession::decl(),
        vibe_kanban::models::project_manager_session::ProjectManagerMessage::decl(),
        vibe_kanban::models::project_manager_session::MessageRole::decl(),
        vibe_kanban::models::project_manager_session::CreateProjectManagerSession::decl(),
        vibe_kanban::models::project_manager_session::SendMessageRequest::decl(),
        vibe_kanban::models::project_manager_session::ProjectManagerSessionWithMessages::decl(),
        vibe_kanban::models::project_manager_session::SendMessageResponse::decl(),
