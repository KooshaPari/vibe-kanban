...
export function ProjectList() {
  ...
  // Project keyboard navigation (simplified for grid layout)
  useEffect(() => {
    function handleKeyDown(e: KeyboardEvent) {
      ...
      } else if (e.key === 'Enter' && projects[currentIndex]) {
        handleViewProjectDetails(projects[currentIndex]);
        return;
      }

      if (newIndex !== currentIndex && projects[newIndex]) {
        setFocusedProjectId(projects[newIndex].id);
        const columns = getGridColumns();
        const newColumnIndex = newIndex % columns;
  ...
  }, [focusedProjectId, projects, handleViewProjectDetails]);
